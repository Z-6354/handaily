...
> **路径更新（2026-07）**：默认 live2d 根目录现为 `data/live2d/`（兼容旧 `仓库根/live2d/`）。架构见 [ARCHITECTURE.md](../../ARCHITECTURE.md)。
...
| 变量 | 说明 |
|------|------|
| `HANDAILY_LIVE2D_PATH` | live2d 根目录，默认仓库 `data/live2d/` |
