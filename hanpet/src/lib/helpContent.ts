  ...
  sections: [
    {
      ...
      icon: "🐾",
      title: "人物与模型",
      body: "打开「人物」页浏览角色列表，点进详情可切换皮肤：「选择皮肤」下桌宠与舰娘为平级分类。点「桌宠」播 Spine 小人，点「舰娘」在同一桌宠窗播 Cubism。下方可配置动作与台词（面向当前桌宠 Spine 模型）。收藏常用角色后，可在列表「收藏」筛选中快速找到；桌宠右键「切换人物」只显示已收藏角色。所有模型、头像与台词资料都保存在本机数据目录。",
    },
    {
      id: "lines",
      icon: "💬",
  ...
  changelog: [
    {
      ...
      date: "2026-07-11",
      body:
        "桌宠交互全面加固：修复主窗关闭/最小化后拖动卡顿、台词气泡反复开关异常、穿透状态不同步等问题；新增设置项「始终置顶」可让桌宠浮于最前或交由全屏应用遮挡。优化主窗与桌宠焦点切换与轻量恢复路径。新增桌宠测试 API 与 MCP 自动化工具（设置页可选开启）。模型切换与收藏菜单更稳定；显示层模块化重构并修复编辑范围漂移。应用图标改为透明底。本版本聚焦 Live2D 纯桌宠体验，已停用日报、AI 分析与微信推送等非桌宠功能。",
    },
    {
      version: "0.1.0",
      date: "2026-07",
