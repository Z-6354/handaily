  ...
  sections: [
    {
      ...
      icon: "🐾",
      title: "人物与模型",
      body: "打开「人物」页浏览角色列表，点进详情可切换皮肤：点皮肤卡片会切到小人（Spine）桌宠，下方可配置动作与台词。舰娘模型为可选，在「动作与台词 → 舰娘皮肤」中同步，并用「舰娘上桌」在桌宠窗顶替显示 Cubism。收藏常用角色后，可在列表「收藏」筛选中快速找到；桌宠右键「切换人物」只显示已收藏角色。所有模型、头像与台词资料都保存在本机数据目录。",
    },
    {
      id: "lines",
      icon: "💬",
