  ...
  sections: [
    {
      ...
      icon: "🐾",
      title: "人物与模型",
      body: "打开「人物」页浏览角色列表，点进详情可切换皮肤：「选择皮肤」下桌宠与舰娘为平级分类，点选后由桌宠窗播放（当前版本两类均播 Spine 小人；舰娘同窗 Cubism 后续接入）。下方可配置动作与台词。收藏常用角色后，可在列表「收藏」筛选中快速找到；桌宠右键「切换人物」只显示已收藏角色。所有模型、头像与台词资料都保存在本机数据目录。",
    },
    {
      id: "lines",
      icon: "💬",
