...
type Props = {
  ...
  onSkinSelect?: (skinId: string, companion?: "auto" | "spine" | "kanmusu") => void;
      ...
      {loading && !detail ? (
        ...
        <div className="persona-detail-layout">
          <aside className="persona-detail-side">
            ...
            {englishName ? (
              <p className="persona-detail-side-en">{englishName}</p>
            ) : null}
            {cv ? <p className="persona-detail-side-en">CV · {cv}</p> : null}
            {skinTag && (
          ...
          <section className="persona-detail-main">
            <div className="persona-detail-body">
              <div className="persona-detail-sections">
                ...
                {activeModelId && activeModelReady !== false && activeSkinId ? (
                  <CharacterPetSettings
                    modelId={activeModelId}
                    characterId={characterId}
                    skinId={activeSkinId}
                    setFeedback={setFeedback}
                    onRefresh={onSkinRefresh}
                  />
                ) : null}
              </div>
            </div>
