...
pub fn run() {
    tauri::Builder::default()
        ...
        .setup(|app| {
            ...
            app.manage(crate::kanmusu::KanmusuRuntimeState::default());
            ...
            // 舰娘：后台同步 Cubism 模型种子
            {
                ...
                tauri::async_runtime::spawn(async move {
                    let data_dir = st_bg.data_dir().to_path_buf();
                    if let Err(e) = crate::kanmusu::ensure_seeded(&data_dir) {
                        crate::log::warn(format!("舰娘种子同步失败: {e}"));
                    }
                });
            }
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            ipc::live2d_commands::characters_get_skin,
            ipc::live2d_commands::characters_update_skin_lines,
            ipc::live2d_commands::characters_pet_menu_kanmusu,
            ...
            ipc::live2d_commands::pet_click_through_poll,
            ipc::live2d_commands::pet_move_noactivate,
            ...
            ipc::live2d_commands::pet_set_hit_areas_visible,
            ...
            ipc::live2d_commands::pet_delete_all_user_models,
            ...
            ipc::kanmusu_commands::kanmusu_update_skin,
            ipc::kanmusu_commands::kanmusu_sync_from_unpacked,
            ipc::kanmusu_commands::kanmusu_player_open,
            ipc::kanmusu_commands::kanmusu_player_close,
            ipc::kanmusu_commands::kanmusu_player_load,
            ipc::kanmusu_commands::kanmusu_desktop_open,
            ipc::kanmusu_commands::kanmusu_player_consume_pending,
            ipc::kanmusu_commands::kanmusu_read_model_asset,
            ipc::kanmusu_commands::kanmusu_read_model_bundle,
            ipc::kanmusu_commands::kanmusu_prime_model,
            ipc::kanmusu_commands::pet_get_companion_engine,
            ipc::kanmusu_commands::kanmusu_menu_characters,
            ipc::kanmusu_commands::kanmusu_menu_skins,
            ipc::kanmusu_commands::kanmusu_menu_skins_for,
            ipc::kanmusu_commands::kanmusu_menu_switch_skin,
        ])
